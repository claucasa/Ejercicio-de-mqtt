...
"""
Esto de qui no funciona. El parametro mqtcc no funciona en un proceso.
"""
#def timer(time,mqtcc):
...
#    msg= f'timer working.timeout: {time}'
#    print(msg)
#    publish.simgle(TIMER_STOP, msg, hostname=BROKER)
#    sleep(time)
#    msg= f'timer working. timeout: {time}'
